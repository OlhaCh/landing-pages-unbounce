(() => {
    ...
    function mentalProgramsSlider(sliderEl) {
        if (document.querySelector(".mental-programs__slider")) return new Swiper(".mental-programs__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.2,
    ...
    function testimonialsSlider(sliderEl) {
        if (document.querySelector(".testimonials__slider")) return new Swiper(".testimonials__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.2,
    ...
    window.addEventListener("load", (function(e) {
        initSliders();
        changeSliders(mentalProgramsSlider, 991.98);
        changeSliders(testimonialsSlider, 991.98);
    }));
    window["FLS"] = false;
})();